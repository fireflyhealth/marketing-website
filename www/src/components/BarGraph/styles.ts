export const Wrapper = [
  'w-full h-[316px] py-6 flex flex-col space-y-3',
  'md:h-[400px] md:flex-row md:space-y-0 md:space-x-2.5',
];
...
export const Description = ['font-size-8 text-black md:text-center'];
