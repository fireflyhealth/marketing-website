...
export const SanityImage: FC<SanityImageProps> = ({
  ...
  // Manually set srcset for images
  // Replecating the srcsets generated by Next/Image
  const srcSetBreakpoints = [
    256, 320, 375, 384, 414, 416, 512, 520, 576, 620, 640, 700, 750, 760, 800,
    828, 832, 995, 1024, 1080, 1152, 1200, 1920,
  ];
  const srcSet = srcSetBreakpoints
    .map(
      (breakpoint) =>
        `${imageBuilder.image(image).width(breakpoint).quality(70).url()} ${breakpoint}w`,
    )
    .toString();
